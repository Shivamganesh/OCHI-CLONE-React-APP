...
const Footer = () => {
  return (
    <div className="w-full min-h-screen px-20 flex py-[9vh] ">
      <div className="first w-1/2 h-full ">
        <h1 className="text-7xl pt-[90px] font-semibold  tracking-tighter leading-none font-[''Neue_Montreal''] ">
          EYE-
        </h1>
        <h1 className="text-7xl  font-semibold tracking-tighter leading-none font-[''Neue_Montreal''] ">
          OPENING
        </h1>

        <div className="logo  pt-[40vh] mt-[90px]">
          <svg
            width="72"
            height="30"
            viewBox="0 0 72 30"
      ...
      <div className="first w-1/2 h-full    ">
        <h1 className="text-[6vw] pt-[100px] font-semibold  tracking-tighter leading-none font-['Neue_Montreal'] ">
          PRESENTATIONS
        </h1>

        <div>
          <h1 className="pt-5 pb-2 ">S:</h1>
        ...
        <div className="flex justify-between items-center ">
          <div>
            ...
            <br />
            <a className=" pb-4 underline   " href="">
              30 Chukarina St
            </a>{" "}
            <br />
            <a className="underline " href="">
        ...
        <div className="flex justify-center items-center gap-80  pt-3  ">
          <h1 className="text-zinc-500">
            &copy; ochi design 2024.{" "}
            <span className="text-zinc-500 underline">Legal Terms</span>{" "}
          </h1>
